...
define(['app'], function (app) {
    ...
    var newsDataFactory = function ($http, $q) {
        ...
        factory.Cafeteria = [
            { itemid: 1, title: "Banana Blast", text: "Low-fat frozen yogurt", picture: "/images/60Banana.png" },
            { itemid: 2, title: "Lavish Lemon Ice", text: "Sorbet", picture: "/images/60Lemon.png" },
            { itemid: 3, title: "Marvelous Mint", text: "Gelato", picture: "/images/60Mint.png" },
            { itemid: 4, title: "Creamy Orange", text: "Sorbet", picture: "/images/60Orange.png" },
            { itemid: 5, title: "Succulent Strawberry", text: "Sorbet", picture: "/images/60Strawberry.png" },
            { itemid: 6, title: "Very Vanilla", text: "Ice Cream", picture: "/images/60Vanilla.png" },
            { itemid: 7, title: "Banana Blast", text: "Low-fat frozen yogurt", picture: "/images/60Banana.png" },
            { itemid: 8, title: "Lavish Lemon Ice", text: "Sorbet", picture: "/images/60Lemon.png" },
            { itemid: 9, title: "Marvelous Mint", text: "Gelato", picture: "/images/60Mint.png" },
            { itemid: 10, title: "Creamy Orange", text: "Sorbet", picture: "/images/60Orange.png" },
            { itemid: 11, title: "Succulent Strawberry", text: "Sorbet", picture: "/images/60Strawberry.png" },
            { itemid: 12, title: "Very Vanilla", text: "Ice Cream", picture: "/images/60Vanilla.png" },
            { itemid: 13, title: "Banana Blast", text: "Low-fat frozen yogurt", picture: "/images/60Banana.png" },
            { itemid: 14, title: "Lavish Lemon Ice", text: "Sorbet", picture: "/images/60Lemon.png" },
            { itemid: 15, title: "Marvelous Mint", text: "Gelato", picture: "/images/60Mint.png" },
            { itemid: 16, title: "Creamy Orange", text: "Sorbet", picture: "/images/60Orange.png" },
            { itemid: 17, title: "Succulent Strawberry", text: "Sorbet", picture: "/images/60Strawberry.png" },
            { itemid: 18, title: "Very Vanilla", text: "Ice Cream", picture: "/images/60Vanilla.png" },
            { itemid: 19, title: "Banana Blast", text: "Low-fat frozen yogurt", picture: "/images/60Banana.png" },
            { itemid: 20, title: "Lavish Lemon Ice", text: "Sorbet", picture: "/images/60Lemon.png" },
            { itemid: 21, title: "Marvelous Mint", text: "Gelato", picture: "/images/60Mint.png" },
            { itemid: 22, title: "Creamy Orange", text: "Sorbet", picture: "/images/60Orange.png" },
            { itemid: 23, title: "Succulent Strawberry", text: "Sorbet", picture: "/images/60Strawberry.png" },
            { itemid: 24, title: "Very Vanilla", text: "Ice Cream", picture: "/images/60Vanilla.png" },
            { itemid: 25, title: "Banana Blast", text: "Low-fat frozen yogurt", picture: "/images/60Banana.png" },
            { itemid: 26, title: "Lavish Lemon Ice", text: "Sorbet", picture: "/images/60Lemon.png" },
            { itemid: 27, title: "Marvelous Mint", text: "Gelato", picture: "/images/60Mint.png" },
            { itemid: 28, title: "Creamy Orange", text: "Sorbet", picture: "/images/60Orange.png" },
            { itemid: 29, title: "Succulent Strawberry", text: "Sorbet", picture: "/images/60Strawberry.png" },
            { itemid: 30, title: "Very Vanilla", text: "Ice Cream", picture: "/images/60Vanilla.png" },
            { itemid: 31, title: "Banana Blast", text: "Low-fat frozen yogurt", picture: "/images/60Banana.png" },
            { itemid: 32, title: "Lavish Lemon Ice", text: "Sorbet", picture: "/images/60Lemon.png" },
            { itemid: 33, title: "Marvelous Mint", text: "Gelato", picture: "/images/60Mint.png" },
            { itemid: 34, title: "Creamy Orange", text: "Sorbet", picture: "/images/60Orange.png" },
            { itemid: 35, title: "Succulent Strawberry", text: "Sorbet", picture: "/images/60Strawberry.png" },
            { itemid: 36, title: "Very Vanilla", text: "Ice Cream", picture: "/images/60Vanilla.png" }
        ];

        return factory;
    };

    newsDataFactory.$inject = injectParams;

    app.factory('newsDataService', newsDataFactory);
});